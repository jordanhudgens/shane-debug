...
class VacationsControllerTest < ActionController::TestCase
  ...
  test "should create vacation" do
    assert_difference('Vacation.count') do
      post :create, vacation: { date: @vacation.date, days: @vacation.days, dept: @vacation.dept, name: @vacation.name }
    end
  ...
  test "should update vacation" do
    patch :update, id: @vacation, vacation: { date: @vacation.date, days: @vacation.days, dept: @vacation.dept, name: @vacation.name }
    assert_redirected_to vacation_path(assigns(:vacation))
  end
